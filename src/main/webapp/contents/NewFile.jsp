...
<body>
    <div calss="wrap">
        <div class="intro">
            <div class="header" id ="link_header">
                ...
                <ul class="nav">
                    ...
                    <li><a href="#link_mainText">ABOUT</a></li>
                    <li><a href="#link_service">SERVICE</a></li>
                    <li><a href="#contents">CONTANT</a></li>
                </ul>
            </div>
        ...
        <ul class="amount">
            ...
            <li> 
                <div>
                    <div class="contents1">와시비 간장</div>
        ...
        <div class="main_text0" id="link_mainText">
            <h1>ABOUT</h1>
            <div class="contents1">우리는 재규어처럼 재빠르게, 남들과는 다르게</div>
            <ul class="icons">
                <li>
                    <div class="icon_img">
                ...
                <li>
                    <div class="icon_img">
                        <img src="image/icon0.svg" alt="">
                    </div>
                    <div class="contents1_bold">은신 기술자 확보</div>
                    <div class="contents2">우리는 언제든지 환술에 걸린것처럼 순식간에 시야에서 사라질 수 있습니다.</div>
                    <div class="more">MORE</div>
                </li>
                <li>
                    <div class="icon_img">
                    ...
                    <div class="contents1_bold">치밀한 계획</div>
                    <div class="contents2">다량의 오징어를 한번에 싹쓸이 하여 시중에 유통할 수 있는 기술력이 있습니다.</div>
                    <div class="more">MORE</div>
                </li>
            </ul>
        </div>
        <div class="main_text1" id="link_service">
            <h1>SERVICE</h1>
            <div class="contents1">엄격한 유통과정으로 까다로운 미식가들에게 납품</div>
            <div class="service">
        ...
        <div class="main_text2" id="contents">
            <ul>
                <li>
                    <div><h1>CONTANT</h1></div>
                    <div>우리에게 파트너십을 신청하거나, 고객이 되어주세요</div>
                    <div class="more2">
                        <a href="index.jsp">더 알아보기</a> 
                    </div>
                </li>
                <li></li>
            </ul>
        ...
        <footer>
            ...
            <div>
                CEO. 배광민 <br>
                Addr. 경기도 광명시 광명2동 100-16 지하2층 <br>
                tel.01093133895 <br>
                COPUYRIGHT 2019. TAMO. ALL RIGHT RESERVED.
            </div>
        </footer>
